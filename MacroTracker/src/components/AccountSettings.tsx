  ...
  return (
    <View>
      ...
      <ListItem bottomDivider containerStyle={styles.listItem}>
        ...
        {showIsLoading ? (
          <ActivityIndicator key="loading" size="small" color={theme.colors.primary} />
        ) : (
          <Text key="text" style={styles.valueText}>
      ...
      <ListItem bottomDivider containerStyle={styles.listItem}>
        ...
        {showIsLoading ? (
          ...
          <View key="coinContainer" style={styles.coinContainer}>
      ...
      {user?.badges && user.badges.length > 0 && (
        <ListItem bottomDivider containerStyle={styles.listItem}>
          ...
          <View key="badges" style={styles.badgesContainer}>
