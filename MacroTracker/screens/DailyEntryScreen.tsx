...
const DailyEntryScreen: React.FC = () => {
  ...
  const toggleOverlay = (foodForEdit?: DailyEntryItem) => { //add food for edit in edit mode
        setIsOverlayVisible(!isOverlayVisible);
        if (foodForEdit) {
            setSelectedFood(foodForEdit.food);
            setGrams(String(foodForEdit.grams)); // Pre-fill grams
        }
         else {
             setSelectedFood(null);
             setGrams("")
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <AddEntryModal
               ...
               setGrams={setGrams}
               filteredFoods={foods} // Pass all foods (no filtering in modal)
