...
interface AddFoodModalProps {
    ...
    handleInputChange: (key: keyof Omit<Food, "id">, value: string, isEdit: boolean) => void; // Modified
...
const AddFoodModal: React.FC<AddFoodModalProps> = ({
    ...
    const handleAiButtonClick = async () => {
		...
		if (mode === 'normal') {
			...
			try {
				...
				Alert.alert("AI Error", "Could not calculate macros.  Please check your ingredients and try again.");
			} finally {
    ...
    return (
        // ... (Rest of the JSX is the same as in the previous example) ...
                <Overlay
            isVisible={isVisible}
                        ...
                        <ScrollView>
                            ...
                            {mode === 'normal' && (
                                <>
                                    ...
                                    <Input
                                        ...
                                        onChangeText={(text) => handleInputChange("calories", text.replace(/[^0-9]/g, ''), !!editFood)} // Improved validation
                                    ...
                                    <Input
                                        ...
                                        onChangeText={(text) => handleInputChange("protein", text.replace(/[^0-9]/g, ''), !!editFood)}
                                    ...
                                    <Input
                                        ...
                                        onChangeText={(text) => handleInputChange("carbs", text.replace(/[^0-9]/g, ''), !!editFood)}
                                    ...
                                    <Input
                                        ...
                                        keyboardType="numeric"
                                        value={getValue("fat")}
                                        onChangeText={(text) => handleInputChange("fat", text.replace(/[^0-9]/g, ''), !!editFood)}
                            ...
                            {mode === 'ingredients' && (
                                <Input
                                    ...
                                    multiline={true}
                                    numberOfLines={4} // Or more, depending on your preference
                                    inputContainerStyle={styles.inputContainerStyle}
                                    inputStyle={styles.inputStyle}
                                    leftIcon={<MaterialCommunityIcons name="food-variant" size={24} color={theme.colors.text} />}
                            ...
                            />
                            {/* Placeholders for Barcode Input */}
